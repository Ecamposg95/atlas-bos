  ...
  return (
    <section className="space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <label className="text-xs text-dax-muted space-y-1 md:col-span-2">
          Descripción
