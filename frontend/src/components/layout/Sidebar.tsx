...
const BRANCH_NAV_GROUPS: { header: string; urls: string[] }[] = [
  { header: 'Mi día',        urls: ['/dataxpos', '/pos'] },
...
const ALL_NAV: NavItem[] = [
  ...
  { label: 'Mi día',            short: 'INI', icon: 'fa-house',               url: '/dataxpos',         group: 'pos',  sort: 0  },
...
const ROLE_ROUTES: Record<Role, string[]> = {
  ...
  GERENTE:          ['/cash-history','/reports','/hr/me','/products','/pos','/sales','/returns','/dataxpos'],
  CAJERO:           ['/pos','/cash-history','/hr/me','/products','/printer-settings','/sales','/returns','/dataxpos'],
  VENDEDOR:         ['/mobile/dashboard','/mobile/query','/mobile/sales','/mobile/profile','/hr/me','/dataxpos'],
  SOPORTE_OPERATIVO:['/mobile/dashboard','/mobile/query','/mobile/profile','/hr/me','/dataxpos'],
  CLIENTE:          ['/portal'],
}
